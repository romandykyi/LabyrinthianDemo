// Taken from https://github.com/mailcmd/js-mgestures
...
var Gestures = function (conf) {
    ...
    _this.distance = function (a, b, detectCircular, normalizeTime) {
        ...
        var time_coef = (a.length * _this.conf.msByChar) / (_this.ts_stop - _this.ts_start);
    ...
    _this.install = function () {
        if (!installed) {
            ...
            // Function to set the canvas size to match the viewport
